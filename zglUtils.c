...
_ZGL void SglToGlFormat(afxPixelFormat pf, GLint *fmt, GLenum *layout, GLenum *type)
{
...
_ZGL GLenum SglToGlImageDimensions(afxNat d)
{
...
_ZGL void AfxToGlVertexFormat(afxVertexFormat fmt, GLint* siz, GLenum* typ, afxNat32* stride)
{
    GLint const sizv[] =
    {
        0,
