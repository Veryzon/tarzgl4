...
_ZGL afxError _DpuBindAndSyncFenc(sglDpu* dpu, afxBool syncOnly, afxFence fenc)
{
    //AfxEntry("pip=%p", pip);
...
_ZGL afxError _SglWaitFenc(afxBool waitAll, afxNat64 timeout, afxNat cnt, afxFence const fences[])
{
    afxError err = AFX_ERR_NONE;
...
_ZGL afxError _SglResetFenc(afxNat cnt, afxFence const fences[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(cnt, fences, afxFcc_FENC);
...
_ZGL afxError _SglFencCtor(afxFence fenc, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &fenc, afxFcc_FENC);
...
_ZGL afxError _SglSemCtor(afxSemaphore sem, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sem, afxFcc_SEM);
