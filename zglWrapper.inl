...
ZGLINL void SglBindTextureUnit(sglDpu* dpu, GLuint unit, GLenum target, GLuint texture)
{
...
ZGLINL void SglUsePipeline(sglDpu* dpu, GLuint program)
{
    afxError err = AFX_ERR_NONE;
    glVmt const* gl = &dpu->gl;
...
ZGLINL void SglBindFramebuffer(sglDpu* dpu, GLenum target, GLuint fbo)
{
    afxError err = AFX_ERR_NONE;
    glVmt const* gl = &dpu->gl;
