...
_ZGL afxError _SglDinRelinkCb(afxDrawDevice ddev, afxDrawContext dctx, afxNat cnt, afxDrawInput din[])
{
...
_ZGL afxError _SglDinCtorCb(afxDrawInput din, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &din, afxFcc_DIN);
